...
// Initiate function to display UFO sightings
...
// Show initial display of all UFO sightings
console.log(tableData);
tableDisplay(tableData);

// Create 'filter table' button
...
button.on("Click", function(event) {
  ...
  if (dateInput.trim() === "" ) {
    // Display the entire database if 'date field' has no date
